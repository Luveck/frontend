...
export class CadenaService {
  ...
  getCadenas(){
    ...
    return this._http.get<any>(`${this._dataServ.baseURL}/Administration/GetAllChain`,
  ...
  getCadenaById(id:string){
    ...
    return this._http.get<any>(`${this._dataServ.baseURL}/Administration/GetChainById?id=${id}`,
      {headers: this.headers}
    )
  }
  ...
  addCadena(formData:any){
    ...
    return this._http.post(`${this._dataServ.baseURL}/Administration/CreateChain`, data, {
      headers: this.headers
    })
  }
  ...
  updateCadena(formData:any, id:number, state:boolean){
    ...
    return this._http.post(`${this._dataServ.baseURL}/Administration/UpdateChain`, data, {
      headers: this.headers
    })
  }
}
